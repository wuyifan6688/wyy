...
<template>
  <div class="flex z-30 items-center p-2 footer-player bg-white dark:bg-black " style='width:85vw;height: 65px;position: fixed;bottom: 0;'>
    <!-- left --> 
    <div v-if="isShow" class="overflow-hidden w-60 h-12 flex-1">
    ...
    <!-- mid -->
    <div :style="{opacity:isShow ? '1' : '0.6'}" class="flex flex-col items-center control flex-1">
    ...
    <!-- right -->
    <div v-if="isShow" class="flex justify-end items-center w-60 flex-1">
      <n-popover
        placement="bottom"
        trigger="hover"
      >
